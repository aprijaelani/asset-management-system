        ...
        <div class="widget widget-default widget-item-icon" onclick="location.href='/merchant';">
            ...
            <div class="widget-data">
                <a href="/merchant">
                    ...
                    <div class="widget-title">Total Merchant</div>
                    <div class="widget-subtitle">Our Merchant</div>
                </a>
            </div>      
            <div class="widget-controls">                                
        ...
        <div class="widget widget-default widget-item-icon" onclick="location.href='/user';">
            ...
            <div class="widget-data">
                <a href="/user">
                    ...
                    <div class="widget-title">Total Engineer</div>
                    <div class="widget-subtitle">Our Engineer</div>
                </a>
            </div>
            <div class="widget-controls">                                
                <a href="#" class="widget-control-right widget-remove" data-toggle="tooltip" data-placement="top" title="Remove Widget"><span class="fa fa-times"></span></a>
